...
export type NavigationSelectionState = Pick<
    SelectionState,
    'selectionType' | 'selectedFolder' | 'selectedTag' | 'selectedProperty' | 'selectedTopicPath'
>;
...
export function SelectionProvider({
    ...
    const navigationSelection = useMemo<NavigationSelectionState>(
        ...
        [state.selectedFolder, state.selectedProperty, state.selectedTag, state.selectedTopicPath, state.selectionType]
    );

...
export const ListPane = React.memo(
    forwardRef<ListPaneHandle, ListPaneProps>(function ListPane(props, ref) {
        ...
        // Topic sort overrides are keyed by topic name, not by the full hierarchy path
        const selectedTopicName = selectedTopicPath ? (selectedTopicPath.split('/').pop() ?? selectedTopicPath) : null;

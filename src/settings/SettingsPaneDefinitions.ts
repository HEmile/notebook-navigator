...
import { renderTopicsTab } from './tabs/TopicsTab';
...
export const SETTINGS_PAGE_GROUP_DEFINITIONS: SettingsPageGroupDefinition[] = [
    ...
    },
    {
        ...
        items: ['navigation-pane', 'shortcuts', 'folders', 'tags-properties', 'topics']
    },
    {
...
const SETTINGS_PANE_DEFINITIONS: SettingsPaneDefinition[] = [
    ...
    {
        id: 'topics',
        getLabel: () => strings.settings.pages.topics.label,
        getDescription: () => strings.settings.pages.topics.description,

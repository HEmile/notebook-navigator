...
export const STRINGS_EN = {
    ...
    commands: {
        ...
        revealActiveTopic: 'Reveal active topic', // Command palette: Reveals the active topic note in the navigator (English: Reveal active topic)
        revealActiveTopicAllPaths: 'Reveal active topic (all paths)', // Command palette: Reveals the active topic note by expanding all paths to root nodes (English: Reveal active topic (all paths))

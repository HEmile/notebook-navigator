    ...
    settings: {
        ...
        items: {
            ...
            limitPinnedToCurrentFolder: {
                name: 'محدود کردن یادداشت‌های سنجاق‌شده به مکان آنها',
                desc: 'یادداشت‌های سنجاق‌شده فقط در پوشه، برچسب یا ویژگی‌ای که در آن سنجاق شده‌اند نمایش داده می‌شوند، نه در نماهای والد.'
            },
            separateNoteCounts: {

    ...
    settings: {
        ...
        items: {
            ...
            limitPinnedToCurrentFolder: {
                name: 'Обмежити закріплені нотатки їх розташуванням',
                desc: 'Закріплені нотатки відображаються закріпленими лише в папці, тегу або властивості, де вони були закріплені, а не в батьківських переглядах.'
            },
            separateNoteCounts: {

    ...
    settings: {
        ...
        items: {
            ...
            limitPinnedToCurrentFolder: {
                name: 'ピン留めノートをその場所に制限',
                desc: 'ピン留めノートは、ピン留めされたフォルダ、タグ、またはプロパティでのみピン留め表示され、上位ビューでは表示されません。'
            },
            separateNoteCounts: {
            ...
            enableFolderNotes: {
                name: 'フォルダノートを有効化',
                desc: '一致するノートファイルを持つフォルダーがクリック可能なリンクとして表示されます。'
            },
            folderNoteType: {
                name: '既定のフォルダノート形式',

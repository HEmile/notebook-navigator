...
export const STRINGS_JA = {
    ...
    commands: {
        ...
        revealActiveTopicAllPaths: 'アクティブなトピックを表示（すべてのパス）', // Command palette: Reveals the active topic note by expanding all paths to root nodes (English: Reveal active topic (all paths))

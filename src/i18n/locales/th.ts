    ...
    settings: {
        ...
        items: {
            ...
            limitPinnedToCurrentFolder: {
                name: 'จำกัดโน้ตที่ปักหมุดไว้ในตำแหน่งของมัน',
                desc: 'โน้ตที่ปักหมุดจะแสดงเป็นปักหมุดเฉพาะในโฟลเดอร์ แท็ก หรือคุณสมบัติที่ปักหมุดไว้เท่านั้น ไม่แสดงในมุมมองระดับบน'
            },
            separateNoteCounts: {

    ...
    settings: {
        ...
        items: {
            ...
            limitPinnedToCurrentFolder: {
                name: 'Ограничить закреплённые заметки их расположением',
                desc: 'Закреплённые заметки отображаются закреплёнными только в папке, теге или свойстве, где они были закреплены, а не в родительских представлениях.'
            },
            separateNoteCounts: {
